...
# Tabel: Atrium_CMDB_NetworkInterface | composite key: DeviceID + NetworkInterfaceID
# =============================================================================
...
LOG_FILE = os.path.join(LOG_DIR, f"sync_network_interface_{datetime.now().strftime('%Y%m%d')}.log")
logging.basicConfig(
    level=logging.INFO,
