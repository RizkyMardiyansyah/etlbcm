...
# Tabel: Atrium_CMDB_ComputerSystem | PK: DeviceID
# =============================================================================
...
LOG_FILE = os.path.join(LOG_DIR, f"sync_computer_system_{datetime.now().strftime('%Y%m%d')}.log")
logging.basicConfig(
    level=logging.INFO,
...
MERGE_KEYS = SCHEMA.get("merge_keys")   # None untuk single PK
